...
function PersonInfo({person, isRequest, onClick}) {
  ...
  return (
    ...
    >
        <img src="https://static.vecteezy.com/system/resources/thumbnails/008/442/086/small/illustration-of-human-icon-user-symbol-icon-modern-design-on-blank-background-free-vector.jpg" alt={`${person.email} profile`} className="profile-photo" />
        ...
        { isRequest
            ?  <div class="friend-request-btns">
                    <Button id='accept-friend-btn' theme={theme == darkTheme ? darkTheme : lightTheme} onClick={() => acceptFriend(person.email)}>+</Button>
                    <Button id='reject-friend-btn' theme={theme == darkTheme ? darkTheme : lightTheme} onClick={() => rejectFriend(person.email)}>-</Button>
                </div>
            : <></>
            }
    </div>
